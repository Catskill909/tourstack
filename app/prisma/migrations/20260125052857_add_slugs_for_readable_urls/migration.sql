/*
  ...
  - Added the required column `slug` to the `Stop` table without a default value. This is not possible if the table is not empty.
  - Added the required column `slug` to the `Tour` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "Collection" ADD COLUMN "sourceLanguage" TEXT;
ALTER TABLE "Collection" ADD COLUMN "texts" TEXT;
ALTER TABLE "Collection" ADD COLUMN "ttsSettings" TEXT;
...
INSERT INTO "new_Stop" ("accessibility", "backupPositioning", "content", "createdAt", "customFieldValues", "description", "id", "image", "interactive", "links", "order", "primaryPositioning", "title", "tourId", "triggers", "type", "updatedAt") SELECT "accessibility", "backupPositioning", "content", "createdAt", "customFieldValues", "description", "id", "image", "interactive", "links", "order", "primaryPositioning", "title", "tourId", "triggers", "type", "updatedAt" FROM "Stop";
DROP TABLE "Stop";
...
INSERT INTO "new_Tour" ("accessibility", "backupPositioningMethod", "createdAt", "description", "difficulty", "duration", "heroImage", "id", "languages", "museumId", "primaryLanguage", "primaryPositioningMethod", "publishedAt", "scheduledPublishAt", "status", "templateId", "title", "updatedAt", "version") SELECT "accessibility", "backupPositioningMethod", "createdAt", "description", "difficulty", "duration", "heroImage", "id", "languages", "museumId", "primaryLanguage", "primaryPositioningMethod", "publishedAt", "scheduledPublishAt", "status", "templateId", "title", "updatedAt", "version" FROM "Tour";
DROP TABLE "Tour";
