...
const SAMPLE_TEXTS: Record<string, string> = {
    ...
    'ar': 'مرحبا! هذه عينة من صوتي. مرحبا بكم في جولة المتحف.',
    'hi': 'नमस्ते! यह मेरी आवाज़ का एक नमूना है। संग्रहालय के दौरे में आपका स्वागत है।',
    'ru': 'Здравствуйте! Это образец моего голоса. Добро пожаловать на экскурсию по музею.',
    'pl': 'Cześć! To próbka mojego głosu. Witamy na wycieczce po muzeum.',
    'sv': 'Hej! Det här är ett prov på min röst. Välkommen till museirundturen.',
    'da': 'Hej! Dette er en prøve af min stemme. Velkommen til museumsturen.',
    'fi': 'Hei! Tämä on näyte äänestäni. Tervetuloa museokierrokselle.',
    'nb': 'Hei! Dette er en prøve av stemmen min. Velkommen til museumsturen.',
    'tr': 'Merhaba! Bu benim sesimin bir örneğidir. Müze turuna hoş geldiniz.',
    'uk': 'Привіт! Це зразок мого голосу. Ласкаво просимо на екскурсію музеєм.',
    'vi': 'Xin chào! Đây là mẫu giọng nói của tôi. Chào mừng bạn đến với chuyến tham quan bảo tàng.',
    'th': 'สวัสดี! นี่คือตัวอย่างเสียงของฉัน ยินดีต้อนรับสู่ทัวร์พิพิธภัณฑ์',
    'id': 'Halo! Ini adalah contoh suara saya. Selamat datang di tur museum.',
    'cs': 'Ahoj! Toto je ukázka mého hlasu. Vítejte na prohlídce muzea.',
    'el': 'Γεια σας! Αυτό είναι ένα δείγμα της φωνής μου. Καλώς ήρθατε στην ξενάγηση του μουσείου.',
    'hu': 'Helló! Ez egy minta a hangomból. Üdvözöljük a múzeumi túrán.',
    'ro': 'Bună! Aceasta este o mostră a vocii mele. Bun venit la turul muzeului.',
    'sk': 'Ahoj! Toto je ukážka môjho hlasu. Vitajte na prehliadke múzea.',
    'bg': 'Здравейте! Това е образец на гласа ми. Добре дошли на обиколката на музея.',
    'ms': 'Helo! Ini adalah sampel suara saya. Selamat datang ke lawatan muzium.',
    'he': 'שלום! זו דוגמה לקול שלי. ברוכים הבאים לסיור במוזיאון.',
};
