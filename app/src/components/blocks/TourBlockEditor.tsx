...
export function TourBlockEditor({
    ...
    const overlayOpacity = (data.overlayOpacity ?? 80) / 100;
    ...
    return (
        <div className="grid grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
                {/* Live Preview */}
                <div>
                    <div className="relative aspect-[9/16] max-h-[500px] overflow-hidden border border-neutral-800 bg-neutral-950 rounded-lg">
                        <img
                            src={displayImage}
                            alt="Tour hero"
                        ...
                        />
                        {/* Gradient overlay — matches renderer */}
            ...
            {/* RIGHT COLUMN — Layout, Image, Appearance, CTA */}
            <div className="space-y-5">
                {/* Layout Selection */}
                <div>
                    <label className="block text-sm font-medium text-[var(--color-text-secondary)] mb-2">
                ...
                <div>
                    ...
                    {data.imageOverride ? (
                        ...
                        >
                            <Upload className="w-5 h-5 mx-auto mb-1.5 text-[var(--color-text-muted)]" />
                ...
                <div>
                    <label className="block text-sm font-medium text-[var(--color-text-secondary)] mb-2">
                        Overlay Darkness: {data.overlayOpacity ?? 80}%
                    </label>
                    <input
                        type="range"
                        min={0}
                        max={100}
                        value={data.overlayOpacity ?? 80}
