...
# Install curl for healthchecks and tsx for running TypeScript. Add sqlite for db tools. Add openssl for Prisma.
RUN apk add --no-cache curl sqlite openssl && npm install -g tsx
